...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    avoiding N+1 sequential execution delays for gh CLI commands. Preserves
    order using executor.map.
    Expected impact: Reduces PR scanning time linearly with the number of PRs.
    """
    kept: List[int] = []
